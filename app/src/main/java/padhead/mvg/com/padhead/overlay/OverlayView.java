...
/**
 * Created by Max on 12/25/2014. Modified from original.
 */
/*
...
public abstract class OverlayView extends RelativeLayout {
	...
	protected int __grabClicks = 0;

	public OverlayView(OverlayService service, int layoutResId, int notificationId, int show) {
		super(service);
		__grabClicks = show;
...
/*
	public void setLayoutResId(int lorid) {
		//this.layoutResId = lorid;
		//reload();

		((ViewManager)this.getParent()).removeView(this);
		LayoutInflater inf = LayoutInflater.from(this.getContext());
		inf.inflate(lorid, this);
		// TODO: Efficient way to do this is here... figure out how to dump all other views... reload does the whole thing, is pretty slow
//		LayoutInflater inflater = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//
//		inflater.inflate(layoutResId, this);
//
